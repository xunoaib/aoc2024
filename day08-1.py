...
for freq in grid:
    ...
    for position_pair in position_pairs:
        ...
        final_x_1 = position_pair[0][0] + transform_x_1
        final_y_1 = position_pair[0][1] + transform_y_1
        final_x_2 = position_pair[1][0] + transform_x_2
        final_y_2 = position_pair[1][1] + transform_y_2
        print(final_x_1, final_x_2)
